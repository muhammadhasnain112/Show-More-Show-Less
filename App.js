...
anc.addEventListener('click', function () {
   if (text.length > 100 && anc.innerText == "See More") {
      para.innerText = text.slice(0, 300);
      anc.innerHTML = `.See More`
   } else if (text.length > 300 && anc.innerText == ".See More") {
      para.innerText = text.slice(0, 500);
      anc.innerHTML = `..See More`
   } else if (text.length > 500 && anc.innerText == "..See More") {
      para.innerText = text.slice(0, 1000);
      anc.innerHTML = `...See More`
   } else if (text.length > 1000 && anc.innerText == "...See More") {
      para.innerText = text;
